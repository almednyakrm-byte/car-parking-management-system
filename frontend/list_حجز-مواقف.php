...
<body class="bg-slate-900 text-white">
    ...
    <main class="container mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24">
        ...
        <div class="flex justify-between mb-4">
            <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                <a href="create_حجز-مواقف.php">Add New Item</a>
            </button>
    ...
    <script>
            ...
            .then(data => {
                ...
                data.forEach(record => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-4 py-2">
                            <a href="edit_حجز-مواقف.php?id=${record.id}" class="text-indigo-500 hover:text-indigo-700">Edit</a>
        ...
        function deleteRecord(id) {
            ...
            .then(data => {
                if (data.success) {
                    const row = document.querySelector(`#records-tbody tr:nth-child(${id})`);
                    row.remove();
                } else {
